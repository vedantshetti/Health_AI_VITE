  ...
  return (
    <div className="w-full">
      <div className="flex items-center space-x-4 mb-8">
        <Link to="/dashboard" className="text-emerald-400 flex items-center text-sm">
      ...
      <div className="bg-[#1E293B] rounded-lg p-8"> {/* Darker panel background */}
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="bg-[#0F172A]/50 p-4 rounded-lg border border-emerald-900/30">
            <h3 className="text-sm font-medium text-gray-200 mb-2">Specific Influencer</h3>
            <input
              type="text"
          ...
          <div className="bg-[#0F172A]/50 p-4 rounded-lg border border-gray-800">
            <h3 className="text-sm font-medium text-gray-200 mb-2">Discover New</h3>
            <input
              type="text"
        ...
        <div className="space-y-4 mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-gray-200 font-medium">Include Revenue Analysis</h3>
